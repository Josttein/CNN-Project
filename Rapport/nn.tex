\startsection[title=Neural network concepts]
...
\startplacefigure[reference=concept,
                  location=bottom,
                  title={A visual}]
\externalfigure[Images/figure_concept.png]
\stopplacefigure
...
\startplacefigure[reference=gradient,
                  location=bottom,
                  title={A visual}]
\externalfigure[Images/figure_gradientstep.png][width=.9\textwidth]
\stopplacefigure
...
\startplacefigure[reference=activation,
                  location=bottom,
                  title={A visual}]
\externalfigure[Images/figure_activation.png]
\stopplacefigure
