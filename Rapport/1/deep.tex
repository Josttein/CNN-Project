...
A neural network is a large network of numerous \quote{neurons}.
These neurons are connected to one another through so called \quote{channels} of data streams.
...
A neural network's job is to process some input data and produce a final \quote{activation}.
